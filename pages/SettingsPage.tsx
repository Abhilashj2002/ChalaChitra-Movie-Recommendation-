...
import { User, Shield, Bell, CheckCircle, RefreshCcw, Globe, Star, MessageSquareText, Send } from 'lucide-react';
        ...
        <section className="glass-panel p-8 rounded-3xl border border-blue-500/10 mb-20">
           <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              ...
              <p className={`text-sm ${theme === 'dark' ? 'text-white/50' : 'text-slate-700'}`}>Tell us how we can improve your experience.</p>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmitFeedback} className="space-y-6">
             ...
             <div>
                ...
                <textarea
                  placeholder="What do you think about ChalaChitra?"
